...
int luat_timer_start(luat_timer_t* timer) {
    ...
    os_timer = rt_timer_create(NULL, luat_timer_callback, (void*)timer->id, timer->timeout,  RT_TIMER_FLAG_PERIODIC | RT_TIMER_FLAG_SOFT_TIMER);
